...
function login(name)
    if name then
        ...
        if active then
            clear()
            setColorText(17, 5, "[0xffffff]Приветствуем на варпе [0x68f029]abcd[0xffffff]!", color.background)
            setColorText(17, 5, "[0xffffff]Магазин был создан при поддержке [0x68f029]3_1415926535[0xffffff]!", color.background)
