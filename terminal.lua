...
local version, port = "modem", 1893
local serverAddress = "25257980-fc8a-41d0-9f6b-e4b68fee9b61"
...
[0x68f029]2. [0xffffff]Что такое монетки? Ответ — это вымышленная валюта. Это не серверная валюта!
[0x68f029]3. [0xffffff]Как обменять товар на монетки? Ответ — нужно выбрать товар  и выбрать режим поиска предметов.
...
function login(name)
    if name then
        ...
        if active then
            clear()
            setColorText(17, 2, "[0xffffff]Приветствуем на варпе [0x68f029]abcd[0xffffff]!", color.background)
            setColorText(17, 4, "[0xffffff]Магазин был создан при поддержке [0x68f029]3_1415926535[0xffffff]!", color.background)
